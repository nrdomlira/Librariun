...
if(comportamento.equals("ExcluirAluno")){
    ...
    <form id="formulario1" action="<%=comportamento%>" method="get">
<fieldset id="aluno" class="formulariobaixo"><legend>Alunos</legend>
            <p>  <label for="matriculaAluno">Matrícula:</label>
                <input type="number"id="matriculaAluno"name="matriculaAlunoo"placeholder="Matricula" 
                size=6 max =999999999 min=99999999 disabled 
            ...
            <p> <label for="cpfAluno">CPF:</label>
                <input type="text" name="cpfAlunoo"id="cpfAluno" onBlur="ValidarCPF(formulario1.cpfAlunoo);" required
				onKeyPress="MascaraCPF(formulario1.cpfAlunoo);" maxlength="14" placeholder="CPF"
                value="<%= comportamento.equals("AlterarAluno") ? aluno.getCpf() : "" %>"/></p>
                
            <p>  <label for="dataAluno">Data de Nascimento:</label>
                <input type="text"id="dataAluno"name="dataAlunoo" maxlength="10" size=10 required
                onBlur="ValidaData(formulario1.dataAlunoo)" onKeyPress="MascaraData(formulario1.dataAlunoo)"
                value="<%= comportamento.equals("AlterarAluno") ? aluno.getData() : "" %>"/><br/></p>
            
            <p>  <label for="telefoneAluno">Telefone:</label>
                <input type="text"name="telefoneAlunoo"id="telefoneAluno"onKeyPress="MascaraTelefone(formulario1.telefoneAlunoo);" required
					maxlength="15"  onBlur="ValidaTelefone(formulario1.telefoneAlunoo);"placeholder="Telefone"
