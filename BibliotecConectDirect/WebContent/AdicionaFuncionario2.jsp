...
%>
    ...
    <form id="formularioFunc" action="<%=comportamento%>" method="get">
        <fieldset id="funcionarios"class="formulariobaixo"><legend>Funcionários</legend>
            ...
            <p>  <label for="matriculaFuncionario" ></label>
                <input type="hidden"id="matriculaFuncionario" name="matriculaFunci" placeholder="Matricula"
                 size=6 max =999999999 min=99999999 
            ...
            <p>   <label for="txtNomeFuncionario" >Nome:</label>
                ...
                maxlength="50" size=35 placeholder="Digite o nome completo" required
