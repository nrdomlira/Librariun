...
<div id="interface">
   ...
   <fieldset  class="formulariobaixo"><legend>Erro</legend>
    	Já existe um usuario cadastrado com as mesmas informações, verifique e tente novamente.
    	 ...
    	 <a href="http://localhost:8080/BibliotecConectDirect/AdicionaFuncionario.jsp?Comportamento=AdicionaFuncionario"><input type="submit" id="cadastraAluno"value="OK"></a>
       </fieldset>
